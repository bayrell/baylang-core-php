...
class List extends \Runtime\Component
{
	...
	{
		$this->emit("valueChange", new \Runtime\Widget\Messages\ValueChangeMessage(new \Runtime\Map([
			"value" => $this->value,
	...
	static function getComponentStyle(){ return ".sortable_list.h-bc0b{position: relative}.sortable_list__item.h-bc0b{display: flex;align-items: center;justify-content: flex-start;border-width: var(--border-width);border-color: var(--color-border);border-style: solid;border-radius: 4px;margin: 5px}.sortable_list__item_drag.h-bc0b, .sortable_list__item_remove.h-bc0b{cursor: pointer;padding: 0px 5px}.sortable_list__item_value.h-bc0b{flex: 1}.sortable_list__item_value.h-bc0b .input, .sortable_list__item_value.h-bc0b .select{padding: 0px 10px;border-color: transparent;border-radius: 0;border-width: 0}.sortable_list__buttons.h-bc0b{text-align: center;margin-top: var(--space)}.sortable_list__shadow_elem.h-bc0b{position: absolute;opacity: 0.5;user-select: none;z-index: 9999999}.sortable_list__shadow_elem.h-bc0b .sortable_list__item_drag{cursor: grabbing}.sortable_list__shadow_elem.h-bc0b .sortable_list__item{margin: 0}.sortable_list-move.h-bc0b, .sortable_list-enter-active.h-bc0b, .sortable_list-leave-active.h-bc0b{transition: all 0.3s ease}.sortable_list-enter-from.h-bc0b, .sortable_list-leave-to.h-bc0b{opacity: 0}"; }
	...
	static function getClassName(){ return "Runtime.Widget.Sortable.List"; }
}